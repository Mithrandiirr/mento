                ...
                <div className='flex flex-row ml-[121px] gap-[79px]'>
                    <div className='flex flex-col mt-[158px]'>
                      ...
                      {main.description}
                        ...
                        <span className='flex flex-row gap-[12px] mt-[45px] items-center'><h4 className='text-[#F2C0F0] text-[24px] leading-[30px] font-semibold'>{main.rate}</h4><p className='text-white font-normal text-[18px] leading-[23px]'>member satisfaction</p></span>
                        </div>
                    </div>
                    <div className='flex-1 justify-end flex '>
                        <div className='relative'>
                        <Img src={urlFor(main.poster).url()} alt="Image" width={796} height={593} className="pic" />
